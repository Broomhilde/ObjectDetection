...
class RetinaNet(nn.Module):
    ...
    def _head_subnet(self, n_classes, n_anchors, final_bias=0., n_conv=4, chs=256):
        layers = [self._conv2d_relu(chs, chs,ks=(13,3), padding=(6,1), bias=True) for _ in range(n_conv)]
        layers += [conv2d(chs, n_classes * n_anchors,ks=(13,3),padding=(6,1), bias=True)]
    ...
    def _model_sizes(self, m: nn.Module, size:tuple=(512, 512), full:bool=True) -> Tuple[Sizes,Tensor,Hooks]:
